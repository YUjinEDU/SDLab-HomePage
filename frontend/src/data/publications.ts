...
export const publications: Publication[] = [
  {
    ...
    title:
      "A Context-Aware Recommendation Framework for Real-Time IoT Stream Data",
    authors: ["Young-Kuk Kim", "Minsu Lee", "Jiyoung Park"],
  ...
  },
  {
    ...
    title:
      "Deep Learning-Based Water Quality Prediction Using Multi-Sensor IoT Data",
    authors: ["Hyunwoo Jung", "Young-Kuk Kim"],
  ...
  },
  {
    ...
    title:
      "Intelligent Service Platform for Smart Farm Based on Bio Big Data Analysis",
    authors: ["Jiyoung Park", "Young-Kuk Kim"],
  ...
  },
  {
    ...
    title:
      "Scalable Real-Time Stream Processing Architecture for Smart City Applications",
    authors: ["Minsu Lee", "Young-Kuk Kim"],
  ...
  },
  {
    ...
    title:
      "Fine Dust Concentration Prediction Model Using Environmental IoT Sensor Networks",
    authors: ["Hyunwoo Jung", "Minsu Lee", "Young-Kuk Kim"],
