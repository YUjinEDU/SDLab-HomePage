...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="rounded-xl border border-border bg-white p-6 card-hover group flex flex-col h-full relative">
      ...
      <h3 className="text-[1.1rem] font-bold text-foreground leading-snug mb-3 pr-2 group-hover:text-primary transition-colors">
        <Link
      ...
      <div className="flex flex-col gap-1.5 mb-4 bg-surface/50 rounded-lg p-3">
        ...
        <p className="text-xs font-mono text-text-secondary flex items-center gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="14"
            height="14"
